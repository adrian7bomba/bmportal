...
add_action('admin_menu', function(){
    ...
    // Słowniki DOSTAWCÓW
    add_submenu_page('bm-brandmanager', 'Kategorie Dostawców', 'Kategorie Dostawców', 'manage_categories', 'edit-tags.php?taxonomy=dostawca_kategoria&post_type=dostawca');
